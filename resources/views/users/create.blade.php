    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-apple-lg shadow-apple p-8 animate-slide-up">
            <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                ...
                <div class="bg-green-50 rounded-apple p-4 border border-green-100">
                    <div class="flex items-center mb-3">
                        ...
                        <span class="text-sm font-semibold text-green-800">WhatsApp Notifications</span>
                    </div>
                    <p class="text-xs text-apple-gray-600 mb-4">Configure WhatsApp number to receive task reminders and ticket updates</p>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="relative">
                            ...
                            <input id="whatsapp_number"
                                   ...
                                   class="pl-10 block w-full px-4 py-3 bg-white border-0 rounded-apple focus:ring-2 focus:ring-green-500 focus:bg-white transition-all duration-200 @error('whatsapp_number') ring-2 ring-red-500 @enderror"
                                   placeholder="+263771234567">
                        </div>
                        @error('whatsapp_number')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-apple-gray-500">Include country code (e.g., +263 for Zimbabwe)</p>
                    </div>
                    ...
                    <div class="flex items-center">
                        <input id="whatsapp_notifications_enabled"
                               ...
                               type="checkbox"
                               value="1"
                               {{ old('whatsapp_notifications_enabled', true) ? 'checked' : '' }}
