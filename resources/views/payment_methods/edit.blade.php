    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-apple-gray-500 mt-1">Update payment method details</p>
            </div>
            ...
            <div class="mb-6 p-4 bg-apple-gray-50 rounded-apple">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-lg font-semibold text-apple-gray-900">{{ $paymentMethod->complaints_count }}</p>
                    </div>
                    <div>
                        <p class="text-xs text-apple-gray-500">Created</p>
                        <p class="text-sm text-apple-gray-900">{{ $paymentMethod->created_at ? $paymentMethod->created_at->format('M d, Y') : 'N/A' }}</p>
                    </div>
                </div>
            </div>
